...
--
-- Värd: localhost
-- Tid vid skapande: 29 nov 2014 kl 09:12
...
INSERT INTO `book_item` (`isbn`, `title`, `book_author_id`, `description`, `shelf`) VALUES
...
INSERT INTO `purchased` (`purchase_id`, `isbn`, `delivered_quantity`, `delivery_date`, `purchase_price`) VALUES
(1, 9136014613, 50, '2014-11-27 13:43:47', NULL),
(2, 9100451924, 20, '2014-11-27 13:44:53', NULL),
(3, 9150104004, 75, '2014-11-27 13:44:53', NULL);
